...
APPLICATION_DATA_MAX_RESULT_BYTES = int(os.getenv("APPLICATION_DATA_MAX_RESULT_BYTES", "2097152"))
...
APPLICATION_LINK_TIMESTAMP_FORMAT = os.getenv("APPLICATION_LINK_TIMESTAMP_FORMAT", "%Y%m%d%H%M%S")
...
VERIFICATION_CONTEXT_SIGNING_KEY = os.getenv(
