...
WORKFLOW_RETENTION_HOURS = int(os.getenv("WORKFLOW_RETENTION_HOURS", "24"))
...
CELERY_TASK_DEFAULT_QUEUE = os.getenv("CELERY_QUEUE", "workflow-dev")
...
CELERY_BEAT_SCHEDULE = {
    "cleanup-expired-workflows-hourly": {
        "task": "apps.workflows.tasks.cleanup_expired_workflows",
        "schedule": 3600.0,
    },
