...
export const productFieldRegistry: Record<string, FieldPresentation> = {
  ...
  personName: { label: '客户姓名', control: 'input', span: 4, placeholder: '请输入客户姓名', persistDraft: false },
  certificateNo: { label: '证件号码', control: 'input', span: 4, placeholder: '请输入证件号码', persistDraft: false },
  phone: { label: '手机号码', control: 'input', span: 4, placeholder: '请输入手机号码', persistDraft: false },
  cardNo: { label: '卡号', control: 'input', span: 4, placeholder: '请输入卡号', persistDraft: false },
  companyName: { label: '企业名称', control: 'input', span: 4, placeholder: '请输入企业名称', persistDraft: false },
