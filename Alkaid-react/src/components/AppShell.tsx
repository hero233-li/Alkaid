...
import { getAutoExpandedMenuKeys, getHiddenMenuKeys } from '../api/portal';
...
export default function AppShell() {
  ...
  useEffect(() => {
    Promise.all([getHiddenMenuKeys(), getDeploymentCapabilities(), getAutoExpandedMenuKeys()])
      .then(([hiddenKeys, capabilities, autoExpandedKeys]) => {
        setHiddenMenuKeys(hiddenKeys);
        setExpandedMenuKeys(autoExpandedKeys);
